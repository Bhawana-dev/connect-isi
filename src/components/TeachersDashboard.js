        ...
        return (
            <>
                ...
                <header id="header">
                    ...
                    <nav>
                        <Link to="/TeachersDashboard"><a>Dashboard</a></Link>
                        <Link to="/TeachersProfile"><a>Profile</a></Link>
                        ...
                        <div className="highlights">
                            ...
                            <section>
                                <div className="content">
                                    <header>
                                        <Link to="/TeachersProfile" className="icon fa-vcard-o"><span
                            ...
                            <section>
                                <div className="content">
                                    <header>
                                        <Link to="/AddStudents" className="icon fas fa-user-plus"><span className="label">Icon</span></Link>
                                        <h3>Add Students</h3>
                                    </header>
                                    <p>You can add new Students.</p>
                                </div>
                            </section>
                            <section>
                                <div className="content">
                                    <header>
                                        <Link to="/ViewStudents" className="icon fas fa-list"><span className="label">Icon</span></Link>
                                        <h3>View all Students</h3>
                                    </header>
                                    <p>You can see the list of the students registered in the system. </p>
                                </div>
                            </section>
                            {/*<section>*/}
                            {/*    <div className="content">*/}
