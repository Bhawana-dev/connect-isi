...
class ViewVotingPolls extends Component {
    ...
    SubmitVotingPoll = async (id) => {                                    //addToTracks arrow function to make api to add new tracks in the database track table
        // const data = {
    ...
    render(){
        return (
            <div>
                ...
                {/*// <!-- Heading -->*/}
                <div id="heading" >
                    <h1>Vote your favourite Teacher</h1>
                </div>
                                                    ...
                                                    <li>
                                                        <form>
                                                            <div onChange={this.onChange.bind(this)}>
                                                                <input type="radio" id="favTeacher" name="favTeacher" value={row.id}
                                                                       onClick={(param)=>this.SubmitVotingPoll(param.currentTarget.value)}/>
...
export default ViewVotingPolls;
